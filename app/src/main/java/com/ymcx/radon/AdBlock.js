(() => {
    const pageScript = () => {
      const hideElements = (hostname) => {
        ...
        style.innerHTML = `ytm-channel-list-sub-menu-renderer, ytm-companion-slot, ytm-promoted-sparkles-web-renderer, ytm-promoted-video-renderer {display: none!important;} \n body {-webkit-tap-highlight-color:transparent !important;}`;
